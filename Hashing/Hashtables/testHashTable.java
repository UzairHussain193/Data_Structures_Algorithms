...
class HashTable {
   ...
   private int count = 0; // The number of (key,value) pairs in the
                          // hash table.
   int size;
   ...
   void dump() { // it is just only displyay method to traverse nodes
      ...
      System.out.println();
      for (int i = 0; i <= count; i++) { // table is array of node
...
class TestHashTable {
   ...
   public static void main(String[] args) {
      ...
      // a.remove("C");
      // System.out.println(table.containsKey("F"));
